...
async function fight() {
    ...
    if (check) {
        ...
        if (pokestats1.atk == pokestats2.atk && pokestats1.hp == pokestats2.hp) {
            ...
            getStatus = "https://bit.ly/draw_gif"; result = "DRAW";
        }
        try {
                ...
                res.send(`
                  ...
                  <style>
                    body {  background-image: url('https://c4.wallpaperflare.com/wallpaper/996/1000/959/pokemon-wallpaper-preview.jpg');}
                          p  { background-color: rgba(218, 247, 166, 0.6); text-align: center;  border-radius: 25px; }
                          ...
                          .image-container img { width: 100%; /* adjust to your desired width */}
                 </style>
                  </head>
                  <body> 
            ...
            boxdata.push({
                "pkm1": {
                    ...
                    "hp": poke1_data.stats[1].base_stat,
